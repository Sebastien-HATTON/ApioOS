...
angular.module('ApioDashboardApplication').controller('ApioDashboardNewController', ['$scope', 'objectService', '$http', '$timeout', function ($scope, objectService, $http, $timeout) {
    $scope.myImage = '';
    ...
    $scope.addNewPin = function () {
        ...
        if ($scope.newPin.hasOwnProperty('propertyName')) {
