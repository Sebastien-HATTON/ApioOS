...
angular.module("ApioDashboardApplication").controller("ApioDashboardImportController", ["$scope", "$http", "FileUploader", "$state", function ($scope, $http, FileUploader, $state) {
    ...
    $scope.gitImport = function (path) {
        ...
        $http.post("/apio/app/gitCloneApp", {gitPath: path}).success(function (data) {
