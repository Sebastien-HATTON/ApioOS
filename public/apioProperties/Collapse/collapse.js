...
apioProperty.directive("collapse", ["currentObject", "socket", "$http", function (currentObject, socket, $http) {
    return {
        restrict: "E",
        transclude: true,
        scope: {},
        templateUrl: "apioProperties/Collapse/collapse.html",
        link: function (scope, elem, attrs, controller) {
            ...
            scope.class = attrs.link || scope.propertyname;
            if (attrs.open === "true") {
                scope.collapse = "in";
            }
            //
