				...
				switch( this.choice ) { 
					case "a5" : 
						...
						if( this.learnBit     == 0 ) {
							...
							//modificato da Lorenzo Di Berardino
							this.manufacturer  = ((   parseInt( "00000000000001111111111100000000" , 2 ) & rawNr ) >>> 8).toString(16) // look up the name of the manufacturer
						}
					break
					case "f6" :
