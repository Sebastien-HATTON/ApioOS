module.exports = {
    ...
    "apio": {
        ...
        "Selco200to400": {
            "send": {},
            "recive": {
                "inverter": "(function(data) { console.log('*******data******', data); var properties = { 'ACVoltage1': '', 'ACVoltage2': ' ', 'ACVoltage3': '', 'ACCurrent1': '', 'ACCurrent2': '', 'ACCurrent3': '', 'DCVoltage1': ' ', 'DCVoltage2': '', 'DCCurrent1': '', 'DCCurrent2': '', 'Allarm': '', 'TotalEnergy': ' ', 'Status': '' }; var property = Object.keys(data.properties)[0]; if (property == 'Selco200to400') { var value = data.properties.Selco200to400.split('|'); properties.ACVoltage1 = value[0]; properties.ACVoltage2 = value[1]; properties.ACVoltage3 = value[2]; properties.ACCurrent1 = value[3]; properties.ACCurrent2 = value[4]; properties.ACCurrent3 = value[5]; properties.DCVoltage1 = value[6]; properties.DCVoltage2 = value[7]; properties.DCCurrent1 = value[8]; properties.DCCurrent2 = value[9]; properties.Allarm = value[10]; properties.TotalEnergy = value[11]; properties.Status = value[12]; } return properties; })",
                "update": "(function(data){console.log('switch');var properties = {'switch':''}; properties.switch=String(Number(data.value)); return properties;})"
            }
        },
        "SenecaS500": {
            "send": {},
            "recive": {
                "energy": "(function(data) { console.log('*******data******', data); var properties = { dati : { 'frequency': '', 'voltage': ' ', 'current': '', 'power': '', 'energy': '', 'impEnergy' : '', 'expEnergy' : '', 'impLagAppEnergy' : '', 'expLagAppEnergy' : '', 'impLagReaEnergy' : '', 'expLagReaEnergy' : '', 'appPower' : '', 'reaPower' : '' } }; var property = Object.keys(data.properties)[0]; if (property == 'SenecaS500') { var value = data.properties.SenecaS500.split('|'); var n = Number(value[0]); for(var h = 1; h<value.length-1; h++){ properties.dati[Object.keys(properties.dati)[n]] = value[h]; console.log('n: ',n); console.log('h: ',h); console.log('this property: ',properties.dati[Object.keys(properties.dati)[n]]); n++; } console.log('******properties: ',properties.dati); } return properties.dati; })",
                "update": "(function(data){console.log('switch');var properties = {'switch':''}; properties.switch=String(Number(data.value)); return properties;})"
            }
        },
        "SenecaMonS600": {
            "send": {},
            "recive": {
                "energy": "(function(data) { console.log('*******data******', data); var properties = { dati : { 'frequency': '', 'voltage': ' ', 'current': '', 'power': '', 'energy': '', 'impEnergy' : '', 'expEnergy' : '', 'impLagAppEnergy' : '', 'expLagAppEnergy' : ''} }; var property = Object.keys(data.properties)[0]; if (property == 'SenecaMonS600') { var value = data.properties.SenecaMonS600.split('|'); var n = Number(value[0]); for(var h = 1; h<value.length-1; h++){ properties.dati[Object.keys(properties.dati)[n]] = value[h]; console.log('n: ',n); console.log('h: ',h); console.log('this property: ',properties.dati[Object.keys(properties.dati)[n]]); n++; } console.log('******properties: ',properties.dati); } return properties.dati; })",
                "update": "(function(data){console.log('switch');var properties = {'switch':''}; properties.switch=String(Number(data.value)); return properties;})"
            }
        },
        "SenecaTriS600": {
            "send": {},
            "recive": {
                "energy": "(function(data) { console.log('*******data******', data); var properties = { dati: { 'frequency': '', 'voltage1': '', 'voltage2': '', 'voltage3': '', 'voltage': '', 'current1': '', 'current2': '', 'current3': '', 'current': '', 'power1': '', 'power2': '', 'power3': '', 'power': '', 'apparentPower1': '', 'apparentPower2': '', 'apparentPower3': '', 'apparentPower': '', 'reactivePower1': '', 'reactivePower2': '', 'reactivePower3': '', 'reactivePower': '', 'impEnergy': '', 'expEnergy': '', 'impLagAppEnergy': '', 'expLagAppEnergy': '' } }; var property = Object.keys(data.properties)[0]; if (property == 'SenecaTriS600') { var value = data.properties.SenecaTriS600.split('|'); var n = Number(value[0]); for (var h = 1; h < value.length - 1; h++) { properties.dati[Object.keys(properties.dati)[n]] = value[h]; console.log('n: ', n); console.log('h: ', h); console.log('this property: ', properties.dati[Object.keys(properties.dati)[n]]); n++; } console.log('******properties: ', properties.dati); } return properties.dati; })"
            }
        },
        "DIN8": {
            "send": {
