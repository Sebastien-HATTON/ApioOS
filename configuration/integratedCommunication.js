module.exports = {
    ...
    "apio" : {
        ...
        "SenecaS600" : {
            "send" : {},
            "recive" : {
                "energy" : "(function(data) { console.log('*******data******', data); var properties = { dati : { 'frequency': '', 'voltage': ' ', 'current': '', 'power': '', 'energy': '', 'impEnergy' : '', 'expEnergy' : '', 'impLagAppEnergy' : '', 'expLagAppEnergy' : ''} }; var property = Object.keys(data.properties)[0]; if (property == 'SenecaS600') { var value = data.properties.SenecaS600.split('|'); var n = Number(value[0]); for(var h = 1; h<value.length-1; h++){ properties.dati[Object.keys(properties.dati)[n]] = value[h]; console.log('n: ',n); console.log('h: ',h); console.log('this property: ',properties.dati[Object.keys(properties.dati)[n]]); n++; } console.log('******properties: ',properties.dati); } return properties.dati; })",
                "update" : "(function(data){console.log('switch');var properties = {'switch':''}; properties.switch=String(Number(data.value)); return properties;})"
            }
        },
        "DIN8" : {
